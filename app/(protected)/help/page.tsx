    ...
    <div>
      <div className="py-2">
        <div className="help-container max-w-xl mx-auto p-8 bg-gray-100 border border-gray-300 rounded-lg shadow-lg dark:bg-boxdark">
          <h1 className="help-title text-2xl font-bold text-gray-800">Need Help?</h1>
          <p className="help-description text-gray-700">
            Welcome to the help page! We here to assist you with any issues or questions you may
            have.
          </p>
