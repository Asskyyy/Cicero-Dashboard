...
import { fetchStudents } from '@backend/services/students';
        ...
        {data.map((student) => (
          <tr key={student.id} data-testid="student-row">
            ...
            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
              <p className="text-sm  text-black dark:text-white">{student.user.email}</p>
            </td>
            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
            ...
            >
              <p className="text-sm">{student.user.status.replace(/_/g, ' ')}</p>
            </td>
            <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
