...
- Stack: Next 15 (App Router)/React 19/TypeScript, Prisma 5 with PostgreSQL, Auth.js NextAuth v5 beta, TailwindCSS + custom design tokens, Radix UI components, Zustand/SWR/react-hook-form/zod, Resend + React Email, framer-motion, optional Firebase dependency present.
